...
@section('content')
  <main class="container py-4">
    <div class="content-container">
      <div class="page-header rounded-4" data-aos="fade-up">
            ...
            <div class="villa-card w-100">
              <div class="villa-card-image-container">
                <a href="{{ url('/detail/' . $villa->slug) }}">
                  <img src="{{ asset('storage/uploads/villas/' . ($villa->foto_slider[0] ?? 'default.jpg')) }}"
                    alt="Foto {{ $villa->nama }}" class="villa-card-image">
                </a>
              ...
              <div class="villa-card-body">
                ...
                <div class="villa-features">
                  <span class="feature-icon" title="Kamar Tidur"><i class="fa-solid fa-bed"></i>
                    {{ $villa->kamar_tidur }}</span>
                  <span class="feature-icon" title="Kamar Mandi"><i class="fa-solid fa-bath"></i>
                    {{ $villa->kamar_mandi }}</span>
                  <span class="feature-icon" title="Kapasitas"><i class="fa-solid fa-users"></i>
                    {{ $villa->kapasitas }}</span>
                </div>
                <div class="villa-card-footer">
                  @php
                    $whatsapp_message = urlencode(
                        'Halo, saya tertarik dengan villa ' . $villa->nama . '. Apakah masih tersedia?',
                    );
                  @endphp
                  <a href="https://wa.me/{{ $villa->nomor_wa }}?text={{ $whatsapp_message }}" class="btn-whatsapp"
                    target="_blank" title="Tanya via WhatsApp">
