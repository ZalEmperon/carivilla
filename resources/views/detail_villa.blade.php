...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --bg-container: #FFFFFF;     /* Putih bersih untuk kontras */
        ...
        .back-button {
            ...
            background-color: rgba(59, 98, 85, 0.5); /* Warna teks utama transparan */
        ...
        .info-item .label { color: var(--accent-primary); }
        .info-item .value { font-weight: 500; }
        .info-item .value.price { color: var(--text-primary); font-weight: 700; }
...
<body>
    ...
    <div class="villa-detail-container">
        <div class="carousel-container">
                    ...
                    <div class="carousel-inner">
                        @foreach($dataVilla->foto_slider as $key => $foto)
                            <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                <img src="{{ asset('storage/' . $foto) }}" class="d-block w-100 villa-main-image" alt="Foto galeri {{ $dataVilla->nama }}">
                            </div>
                        @endforeach
                    </div>
            ...
            @else
                <img src="https://placehold.co/1200x450/E2DFDA/3B6255?text=Gambar+Tidak+Tersedia" class="villa-main-image" alt="Gambar tidak tersedia">
            @endif
        </div>
        ...
        <div class="villa-content">
            ...
            <section class="mt-5">
                ...
                @endphp
                <a href="https://wa.me/{{ $dataVilla->nomor_wa }}?text={{ $whatsapp_message }}" target="_blank" class="whatsapp-button w-100">
